...
\usepackage{geometry}                   % Setzt die Seitenabstände auf Vorgabe von Leitfaden
\geometry{a4paper,left=35mm,right=30mm, top=30mm, bottom=30mm} % zusätzlich verwendbar: , headsep=10mm, footskip=12mm % abstand kopfzeile - text, abstand text - fusszeile
...
\newcommand{\footcite}[2][]{\footnote{\citealp[~vgl.][#1]{#2}}}     % Zitierstellen in Fussnoten (vgl.)
\newcommand{\footcites}[2][]{\footnote{\citealp[~siehe][#1]{#2}}}   % Zitierstellen in Fussnoten (siehe)
\newcommand{\footnotecite}[2]{ \[\citealp[vgl.][#1]{#2}\]}}
\newcommand{\footnotecites}[2]{ \[\citealp[siehe][#1]{#2}\]}}
\newcommand{\citefigure}[2][]{\citealp[Quelle:][#1]{#2}}}           % Bilder (Originalübernahme)
\newcommand{\citefiguremodified}[2][]{\citealp[Quelle: modifiziert nach][#1]{#2}}}  % Bilder (modifiziert)
\newcommand{\citefiguredata}[2][]{\citealp[Quelle: eigene Darstellung, Daten entnommen aus][#1]{#2}}}   % Bilder (Daten entnommen)
\newcommand{\citefigureown}{Quelle: eigene Darstellung}     % Bilder (eigene Darstellung)
